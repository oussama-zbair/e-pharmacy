...
-->
        ...
        @if (Route::current()->getName()=='userinfo')
        <li class="nav-item active">
        ...
        @if (Route::current()->getName()=='pharmalist')
        <li class="nav-item active">
            <a class="nav-link" href="/pharmalist">
        ...
        @endif
        @if (Route::current()->getName()=='pharmacie')
        <li class="nav-item active">
            <a class="nav-link " href="./pharmacie">
                <i class="nc-icon nc-atom"></i>
                <p>ajouter pharmacie</p>
            </a>
        </li>
        @else
        <li class="nav-item">
